                                            ...
                                            <ul class="panel2">
                                                ...
                                                <li class="nk-menu-item">
                                                    <a href="crypto/BOT.php" class="nk-menu-link">
                                                        <span class="nk-menu-text">PrimeCore Capitals BOT 3.5</span>
                                                    </a>
                                                </li>
                                            </ul>
                                            <div class="nk-profile-content toggle-expand-content" data-content="sidebarProfile">
                ...
                <div class="nk-footer">
                    <div class="container-fluid">
                        <div class="nk-footer-wrap">
                            <div class="nk-footer-copyright"> &copy; 2024  PrimeCore Capitals.
                            </div>
...
<a href="mailto:'support@ PrimeCore Capitalss.net'"><img src="../../emailpng.png" class="feedback" alt="email"/></a>
</div>
        <style>
         .feedback {
             width:62px;
