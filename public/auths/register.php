                        ...
                        <div class="nk-split-content nk-block-area nk-block-area-column nk-auth-container bg-white w-lg-45">
                            <div class="nk-block nk-block-middle nk-auth-body">
                                <div class="brand-logo pb-5">
                                    <a href="html/index.html" class="logo-link">
                                       <img class="logo-dark" style="width:192px; height:62px;" src="https:// PrimeCore Capitalss.net/io.png"/>
                                ...
                                <form method="post">
                                    ...
                                    <div class="form-gronup">
                                        <div class="custom-control custom-control-xs custom-checkbox">
                                            ...
                                            <label class="custom-control-label" for="checkbox">I agree to  PrimeCore Capitalss <a tabindex="-1" href="https:// PrimeCore Capitalss.net/privacy.html">Privacy Policy</a> &amp; <a tabindex="-1" href="https:// PrimeCore Capitalss.net/terms.html"> Terms.</a></label>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="form-group">
                            ...
                            <div class="nk-block nk-auth-footer">
                                <div class="nk-block-between">
                                    <ul class="nav nav-sm">
                                        <li class="nav-item">
                                            <a class="nav-link" href="https:// PrimeCore Capitalss.net/terms.html">Terms & Condition</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="https:// PrimeCore Capitalss.net/privacy.html">Privacy Policy</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="https:// PrimeCore Capitalss.net/contact.html">Contact Us</a>
                                        </li>
                                ...
                                <div class="mt-3">
                                    <p>&copy; 2024  PrimeCore Capitalss. All Rights Reserved.</p>
                                </div>
                            </div><!-- nk-block -->
