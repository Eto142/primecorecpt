          ...
          <div class="col">
           ...
           <!-- <div class="refer-form-content">
              ...
              <!--<form action="" method="post">-->
                ...
                <input type="text" id="refer" value="https:// PrimeCore Capitalss.net/src/auths/register.php?refer=94388539" disabled>
                <!--<input type="text" id="refer" value="https:// PrimeCore Capitals.com/src/auths/register.php?refer=94388539">-->
                <!--<p>-->
